...
def star(name):
    ...
    while 1:
        ...
        num += 1
        url2 = url + str(num)
        headers = {"Accept": "application/vnd.github.v3.star+json","Authorization": "token 90672317cc03a53f1a62b91652276f3beb6f24cf"}
    ...
    star.to_csv('E:\\7_Intern\\GGV\\com\\star_'+name+'.csv',index = False,header = False)
...
def fork(name):
    ...
    while 1:
        ...
        num += 1
        url2 = url + str(num)
        headers = {"Authorization": "token 90672317cc03a53f1a62b91652276f3beb6f24cf"}
#        headers = {"Authorization": "token 9b64e2664abeb1fb88d2ffa0bf520a34db38ef7e"}
        false = False
        true = True
        null = "Null"
        with requests.get(url2,headers=headers) as r:
        ...
        e = time()
        print(url2,str(e-b)+' Cost')
    star.to_csv('E:\\7_Intern\\GGV\\fork\\fork_'+name+'.csv',index = False,header = False)
def commits(name):
    name1 = name.replace('_','/')
    ...
    while 1:
        ...
        e = time()
        print(url2,str(e-b)+' Cost')
    star.to_csv('E:\\7_Intern\\GGV\\commits\\comm_'+name+'.csv',index = False,header = False)
...
#        headers = {"Authorization": "token 90672317cc03a53f1a62b91652276f3beb6f24cf"}
        ...
        e = time()
        print(url2,str(e-b)+' Cost')
    star.to_csv('E:\\7_Intern\\GGV\\issues\\issu_'+name+'.csv',index = False,header = False)
